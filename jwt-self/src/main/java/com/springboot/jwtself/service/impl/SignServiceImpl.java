...
import com.springboot.jwtself.common.CommonResponse;
import com.springboot.jwtself.config.security.JwtTokenProvider;
...
import com.springboot.jwtself.service.SignService;
...
public class SignServiceImpl implements SignService {
  ...
  public SignUpResultDto signUp(String id, String password, String name, String role) {
    log.info("회원가입 정보 요청, id : {}, passowrd : {}");
    User user;
  ...
  public SignInResultDto signIn(String id, String password) throws RuntimeException {
    ...
    SignInResultDto signInResultDto = SignInResultDto.builder()
        .token(jwtTokenProvider.generateToken(String.valueOf(user.getUid()), user.getRoles()))
        .build();
